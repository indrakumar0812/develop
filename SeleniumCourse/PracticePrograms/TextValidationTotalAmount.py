...
OriginalAmnt = driver.find_element_by_css_selector("span.discountAmt").text
...
assert float(DiscountAmnt) < int(OriginalAmnt)
...
totalamnt = int(driver.find_element_by_css_selector(".totAmt").text)

assert totalamnt == sum